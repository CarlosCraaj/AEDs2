...
class No {
    ...
    {
		this(musica, null, null);
	}

	public No (Musica musica, No esquerda, No direita) 
    {
		this.music = musica.clone();
		this.esq = esquerda;
		this.dir = direita;
	}
}
...
class ArvoreBinaria {
	...
	public void inserir(Musica musica) throws Exception {
		raiz = inserir(musica, raiz);
	}

	private No inserir(Musica musica, No i) throws Exception {
        ...
        {
		    i.esq = inserir(musica, i.esq);
		} else if (musica.getID().compareTo(i.music.getID()) > 0) 
        {
			i.dir = inserir(musica, i.dir);
      	} else {
		    throw new Exception("Erro ao inserir!");
      	}
	...
	private boolean pesquisar(String x, No i) {
        ...
        {
            resp = false;
        }else if(x.compareTo(i.music.getID()) == 0)
        {
            resp = true;
        }else if(x.compareTo(i.music.getID()) < 0)
        {
