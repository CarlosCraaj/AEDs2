...
class PilhaFlex
{
	...
	public void inserir(Musica music) 
    {
    ...
    public void mostraPilha(int size) 
    {
		mostraPilha(topo, size);
	}

	private void mostraPilha(Celula i, int j) 
    {
		if (i != null) {
			mostraPilha(i.prox, j-1);
			MyIO.print("[" + j + "] ");
            i.elemento.imprimir();
		}
	}
