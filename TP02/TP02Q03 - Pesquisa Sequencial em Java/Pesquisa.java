...
class Pesquisa
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String[] pubinPes = new String[100];
        ...
        do
        {
            pubinPes[nPes] = MyIO.readLine();
            nPes++;
        }while(Musica.isFim(pubinPes[nPes-1]) == false);
        nPes--; //Tirar a palavra FIM

        int i = 0;
        Arq.openWrite("683471_sequencial.txt", "UTF-8");
        ...
        Arq.println("683471" + "\t" + (fim-inicio)/1000.0 + "\t" + comp[0]);
